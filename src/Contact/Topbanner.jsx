        ...
        <h1
          ...
          >
           Let's Work Together
            ...
            Ready to bring your <span className="text-white rounded bg-gradient-to-b from-blue-800 via-purple-700">vision to life? </span> I'd love to hear about your project.
            </span>
          </h1>
        {/* <h1 className="text-gray-900 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold drop-shadow-lg">
          Design Services
        </h1>
        <p className="text-gray-700 text-base sm:text-lg md:text-xl lg:text-[22px] py-4 max-w-2xl mx-auto">
